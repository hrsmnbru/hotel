 ...
 * @author cleim
 */
public class TemplateCadastroP1 extends javax.swing.JDialog {

    /**
     * Creates new form TemplateCadastroP1
     */
    public TemplateCadastroP1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                TemplateCadastroP1 dialog = new TemplateCadastroP1(new javax.swing.JFrame(), true);
