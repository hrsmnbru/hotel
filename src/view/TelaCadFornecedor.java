 ...
 * @author aluno
 */
public class TelaCadFornecedor extends javax.swing.JDialog {

    /**
     * Creates new form TemplateCadastro
     */
    public TelaCadFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaCadFornecedor dialog = new TelaCadFornecedor(new javax.swing.JFrame(), true);
