 ...
 * @author cleim
 */
public class TelaCadProdutoCopa extends javax.swing.JDialog {

    /**
     * Creates new form TemplateCadastroP1
     */
    public TelaCadProdutoCopa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                TelaCadProdutoCopa dialog = new TelaCadProdutoCopa(new javax.swing.JFrame(), true);
