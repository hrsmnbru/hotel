 ...
 * @author cleim
 */
public class TelaCadVagaEstacionamento extends javax.swing.JDialog {

    /**
     * Creates new form TemplateCadastroP1
     */
    public TelaCadVagaEstacionamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CADASTRO DE VAGA DE ESTACIONAMENTO");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                TelaCadVagaEstacionamento dialog = new TelaCadVagaEstacionamento(new javax.swing.JFrame(), true);
